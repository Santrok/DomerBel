...
# b74fbd278a040f2416d84b611435ed2b336d9086162f8b71ea6719e4412ae213

resp = requests.get('https://checkout.bepaid.by/ctp/api/checkouts/9e81e095969462d122aef7bf00a2c29ef3e6b870ecdc77a7cc03211578607163', auth=HTTPBasicAuth(store_id, secret_key))
# resp = requests.get('https://gateway.bepaid.by/transactions//e9dd9b2b-a9fa-4b91-9f6f-9a198d95bff6', auth=HTTPBasicAuth(store_id, secret_key))
