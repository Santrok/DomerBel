...
urlpatterns = [
    ...
    # path('dialogs/<slug:slug>', create_dialog, name='create_dialog'),
    path('dialogs/create/user:<int:user_id>_and_user:<int:recipient_id>/<slug:advertisement>/', create_dialog, name='create_dialog'),
